...
function GUI.app(x, y, w, h, name)
	...
	local lena = unicode.len(name)
	
	local init_name = GUI.label((w/2)-math.ceil(lena/2), 1, window.width, 1, GUI.SystemColor.regularText, name)
	window:addChild(init_name)
